 ...
 * @author Mouse
 */
public class Numero_a_Letra extends JRDefaultScriptlet {
   ...
   public Numero_a_Letra() {
    ...
    public String Convertir(String numero, boolean mayusculas) {
        ...
        if (Pattern.matches("\\d{1,9},\\d{1,2}", numero)) {
            ...
            parte_decimal = Num[1] + "Pesos M/cte.";
            ...
            if (mayusculas) {
                return (literal + parte_decimal.replace("00", "")).toUpperCase();
            
            } else {
                return (literal + parte_decimal.replace("00", ""));
            }
    ...
    System.out.println("Miles: "+miles);
       ...
       System.out.println("Millon "+millon);
        ...
        if(millon.length()> 1){
            ...
            n = getUnidades(millon) + "millon"+"(es) ";
    ...
    public String numeroFormateado(double numero){
